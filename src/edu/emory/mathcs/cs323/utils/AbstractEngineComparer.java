...
public abstract class AbstractEngineComparer<EngineType> {
	...
	public long[][] printTotal(final int ITERATIONS, final int INIT_SIZE, final int MAX_SIZE, final int INCREMENT,
			final int OPS, final Random RAND, EngineType... engines) {
