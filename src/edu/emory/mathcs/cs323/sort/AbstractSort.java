...
public abstract class AbstractSort<T extends Comparable<T>> {
	 ...
	 *            an array of comparable keys.
	 * @param index
	 *            the index of the array to assign.
	 * @param value
	 ...
	 *            an array of comparable keys.
	 * @param beginIndex
	 *            the index of the first key to be sorted (inclusive).
	 * @param endIndex
	 *            the index of the last key to be sorted (exclusive).
	 */
