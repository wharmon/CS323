...
public class DKnapsack extends AbstractKnapsack {
	...
	/**
	 * @param items
	 *            sorted by their weights in ascending order.
	 */
	private List<KnapsackItem> solve(KnapsackItem[] items, int maxWeight, int index,
			Map<String, List<KnapsackItem>> map) {
	...
	private List<KnapsackItem> solveAux(KnapsackItem[] items, int maxWeight, int index,
			Map<String, List<KnapsackItem>> map) {
