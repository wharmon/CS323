...
public abstract class AbstractLCS {
	 ...
	 * @param b
	 *            the second string.
	 * @return a longest common sequence of the specific strings {@code a} and
	 *         {@code b}.
	 */
	 ...
	 * @param i
	 *            the index of {@code c} to be compared.
	 * @param j
	 *            the index of {@code d} to be compared
	 * @return a longest common sequence of the specific strings {@code c} and
	 *         {@code d}.
	 */
