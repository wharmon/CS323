...
public abstract class AbstractBinarySearchTree<T extends Comparable<T>, N extends AbstractBinaryNode<T, N>> {
	...
	/**
	 * @return the node with the specific key if exists; otherwise,
	 *         {@code null}.
	 */
	public N get(T key) {
	...
	/**
	 * @return {@code true} if the specific key exists; otherwise,
	 *         {@code false}.
	 */
	...
	/**
	 * @return the new node that is added to this tree. If this tree already
	 *         contains the key, nothing is added.
	 */
	public N add(T key) {
		N node = null;
	...
	/**
	 * @return the removed node with the specific key if exists; otherwise,
	 *         {@code null}.
	 */
