...
public class MSTHarmon implements MSTAll 
{
	...
	public List<SpanningTree> getMinimumSpanningTrees(Graph graph) 
	{
		...
		for (int i = 0; i < graph.size(); i++) 
		{
			...
			if (i+1<graph.size()-1) add(graph, queue, visited, tree, i+1);
	 ...
	 */
	public List<SpanningTree> getMinimumSpanningTrees(Graph graph, List<SpanningTree> list, PriorityQueue<Edge> queue, Set<Integer> visited, SpanningTree tree) 
	{
		if (list.size() < 1) ;
